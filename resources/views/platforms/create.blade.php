                ...
                <form action="{{ route('platforms.store') }}" method="post" class="Label" enctype="multipart/form-data">
                    ...
                    <div class="row p-2">
                        <div class="col-sm-2">
                            ...
                            <input type="text" class="form-control form-control-sm @error('platform_name') border border-danger @enderror" name="platform_name" id="platform_name" placeholder="Platform" value="{{ old('platform_name') }}" required>
                        </div>
                        <div class="col-sm-2">
