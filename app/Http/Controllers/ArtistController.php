...
class ArtistController extends Controller
{
    ...
    public function store(StoreArtistRequest $request)
    {
        ...
        if ($get_artist_id) {
            return redirect()->route('artists.create')->with('error', 'Artist ' . $request->input('artist_name') . ' is already in the database.');
        }
        if (!$get_artist_id) {
...
/*             //save the image 
            ...
            return redirect()->route('artists.create')->with('info', 'Artist ' . $request->input('artist_name') . ' added successfully');
        }
    }
